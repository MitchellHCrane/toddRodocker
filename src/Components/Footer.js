    ...
    <footer>
      <div className="footer-div">
        <div className="footerGridItem">
          ...
          <p className="footerP">
            Phone: <a href="tel:801-694-0903">(801)-694-0903</a>
          </p>
          <p className="footerP">Fax: (801)-303-7083</p>
          <p className="footerP">
            Email:{" "}
            <a href="mailto:toddrodocker@gmail.com">toddrodocker@gmail.com</a>
          </p>
        </div>
        <div className="footerGridItem">
          <h3 className="footerH3">License Info</h3>
          <p className="footerP">J Todd Rodocker (NMLS #317650)</p>
          <p className="footerP">
